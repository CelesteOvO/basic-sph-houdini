...
#ifndef FLUID_HOUDINI_TEST_PCISPH_SOLVER_H
#define FLUID_HOUDINI_TEST_PCISPH_SOLVER_H
...
class PCISPHSolver : public SIM_SingleSolver, public SIM_OptionsUser
{
public:
private:
    explicit PCISPHSolver(const SIM_DataFactory *factory) : SIM_SingleSolver(factory), SIM_OptionsUser(this) {}
    ~PCISPHSolver() override = default;
    ...
    DECLARE_DATAFACTORY(PCISPHSolver, SIM_SingleSolver, "PCISPH Solver Description", GetDescription());
    // ==================== Custom Field ====================
protected:
...
#endif //FLUID_HOUDINI_TEST_PCISPH_SOLVER_H
